...
int sAloonchoice,sAnschoice,tIcketnum;//marboot be reservation//ticketnum:tedade ticket
...
void rEservesans(void){
	sHowavailabelsanses();
	printf("Enter:\n\tSaloon Number:");
	scanf("%d",&sAloonchoice);
	printf("\n\tSans Number:");
	scanf("%d",&sAnschoice);
	printf("How Many Tickets Do You Wnat?:")
	scanf("%d",&tIketnum);
	///bayad yekari koni k tedade baghimande dar khode struct sans zakhire beshe to file
	////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////
}
